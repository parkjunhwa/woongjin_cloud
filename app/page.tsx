...
// 공통 컬러 테마 클래스 함수들
const getRadioColorClasses = (baseColor: string) => {
  const colorMap: Record<string, { hoverBorder: string; indicatorBg: string }> = {
...
const getCheckboxColorClasses = (baseColor: string) => {
  const colorMap: Record<string, { checkedBorder: string; indicatorText: string }> = {
...
const getRadioCardColorClasses = (baseColor: string) => {
  const colorMap: Record<string, { cardBorder: string; cardBg: string; indicatorBg: string; text: string }> = {
...
const getCheckboxCardColorClasses = (baseColor: string) => {
  const colorMap: Record<string, { cardBorder: string; cardBg: string; checkboxCheckedBg: string; checkboxCheckedBorder: string; checkboxIndicatorText: string; text: string }> = {
...
const getSwitchColorClasses = (baseColor: string) => {
  const colorMap: Record<string, { checkedBg: string }> = {
...
const getToggleGroupColorClasses = (baseColor: string) => {
  const colorMap: Record<string, { onBg: string }> = {
...
const getTabsColorClasses = (baseColor: string) => {
  const colorMap: Record<string, { activeBorder: string; activeText: string }> = {
    blue: { activeBorder: "data-[state=active]:border-blue-500 dark:data-[state=active]:border-blue-600", activeText: "data-[state=active]:text-blue-600 dark:data-[state=active]:text-blue-400" },
    red: { activeBorder: "data-[state=active]:border-red-500 dark:data-[state=active]:border-red-600", activeText: "data-[state=active]:text-red-600 dark:data-[state=active]:text-red-400" },
    green: { activeBorder: "data-[state=active]:border-green-500 dark:data-[state=active]:border-green-600", activeText: "data-[state=active]:text-green-600 dark:data-[state=active]:text-green-400" },
    yellow: { activeBorder: "data-[state=active]:border-yellow-500 dark:data-[state=active]:border-yellow-600", activeText: "data-[state=active]:text-yellow-600 dark:data-[state=active]:text-yellow-400" },
    purple: { activeBorder: "data-[state=active]:border-purple-500 dark:data-[state=active]:border-purple-600", activeText: "data-[state=active]:text-purple-600 dark:data-[state=active]:text-purple-400" },
    pink: { activeBorder: "data-[state=active]:border-pink-500 dark:data-[state=active]:border-pink-600", activeText: "data-[state=active]:text-pink-600 dark:data-[state=active]:text-pink-400" },
    indigo: { activeBorder: "data-[state=active]:border-indigo-500 dark:data-[state=active]:border-indigo-600", activeText: "data-[state=active]:text-indigo-600 dark:data-[state=active]:text-indigo-400" },
    teal: { activeBorder: "data-[state=active]:border-teal-500 dark:data-[state=active]:border-teal-600", activeText: "data-[state=active]:text-teal-600 dark:data-[state=active]:text-teal-400" },
    orange: { activeBorder: "data-[state=active]:border-orange-500 dark:data-[state=active]:border-orange-600", activeText: "data-[state=active]:text-orange-600 dark:data-[state=active]:text-orange-400" },
    gray: { activeBorder: "data-[state=active]:border-gray-500 dark:data-[state=active]:border-gray-600", activeText: "data-[state=active]:text-gray-600 dark:data-[state=active]:text-gray-400" },
    cyan: { activeBorder: "data-[state=active]:border-cyan-500 dark:data-[state=active]:border-cyan-600", activeText: "data-[state=active]:text-cyan-600 dark:data-[state=active]:text-cyan-400" },
    emerald: { activeBorder: "data-[state=active]:border-emerald-500 dark:data-[state=active]:border-emerald-600", activeText: "data-[state=active]:text-emerald-600 dark:data-[state=active]:text-emerald-400" },
    violet: { activeBorder: "data-[state=active]:border-violet-500 dark:data-[state=active]:border-violet-600", activeText: "data-[state=active]:text-violet-600 dark:data-[state=active]:text-violet-400" },
    fuchsia: { activeBorder: "data-[state=active]:border-fuchsia-500 dark:data-[state=active]:border-fuchsia-600", activeText: "data-[state=active]:text-fuchsia-600 dark:data-[state=active]:text-fuchsia-400" },
    rose: { activeBorder: "data-[state=active]:border-rose-500 dark:data-[state=active]:border-rose-600", activeText: "data-[state=active]:text-rose-600 dark:data-[state=active]:text-rose-400" },
    amber: { activeBorder: "data-[state=active]:border-amber-500 dark:data-[state=active]:border-amber-600", activeText: "data-[state=active]:text-amber-600 dark:data-[state=active]:text-amber-400" },
    lime: { activeBorder: "data-[state=active]:border-lime-500 dark:data-[state=active]:border-lime-600", activeText: "data-[state=active]:text-lime-600 dark:data-[state=active]:text-lime-400" },
    sky: { activeBorder: "data-[state=active]:border-sky-500 dark:data-[state=active]:border-sky-600", activeText: "data-[state=active]:text-sky-600 dark:data-[state=active]:text-sky-400" }
  };
  return colorMap[baseColor] || colorMap.blue;
};
                    ...
                    <Tabs.List className="flex gap-2 border-b border-gray-200 dark:border-gray-800">
                      {["tab1", "tab2", "tab3"].map((tab) => (
                        <Tabs.Trigger
                          key={tab}
                          value={tab}
                          className={`rounded-t-lg px-4 py-2 text-sm hover:text-gray-900 dark:hover:text-gray-100 data-[state=active]:border-b-2 ${tabsColorClasses.activeBorder} ${tabsColorClasses.activeText} text-gray-600 dark:text-gray-400 transition-colors`}
                        >
                          탭 {tab.slice(-1)}
                        </Tabs.Trigger>
                      ))}
